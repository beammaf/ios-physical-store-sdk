...
/// Detected Store Beacon
- (void)detectedStoreWithStore:(SWIFT_NOESCAPE void (^ _Nonnull)(PSStore * _Nonnull))store;
/// Detected Terminal Beacon
- (void)detectedTerminalWithTerminal:(SWIFT_NOESCAPE void (^ _Nonnull)(PSTerminal * _Nonnull))terminal;
@end
...
@property (nonatomic, weak) id <TerminalDetecable> _Nullable delegate;
...
SWIFT_PROTOCOL("_TtP16PhysicalStoreSdk17TerminalDetecable_")
@protocol TerminalDetecable
- (void)didScanStarted;
- (void)didBeaconDetected;
- (void)didScanStopped;
- (void)didResultStoreWithStore:(PSStore * _Nonnull)store;
- (void)didResultTerminalWithTerminal:(PSTerminal * _Nonnull)terminal;
- (void)didErrorOccuredWithError:(NSError * _Nonnull)error;
@end
